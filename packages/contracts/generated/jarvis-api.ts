...
export interface paths {
    ...
    "/api/v1/missions/{mission_id}/directive": {
        ...
        get?: never;
        /** Update Directive */
        put: operations["update_directive_api_v1_missions__mission_id__directive_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/v1/missions/{mission_id}/messages": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List Messages */
        get: operations["list_messages_api_v1_missions__mission_id__messages_get"];
        put?: never;
        /** Create Message */
        post: operations["create_message_api_v1_missions__mission_id__messages_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/missions/{mission_id}/work-items": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List Items */
        get: operations["list_items_api_v1_missions__mission_id__work_items_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/missions/{mission_id}/work-items/{item_id}/start": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Start Item */
        post: operations["start_item_api_v1_missions__mission_id__work_items__item_id__start_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/operations/alerts": {
        ...
        /** Operational Alerts */
        get: operations["operational_alerts_api_v1_operations_alerts_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/operations/alerts/evaluate": {
        ...
        put?: never;
        /** Evaluate Alerts */
        post: operations["evaluate_alerts_api_v1_operations_alerts_evaluate_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/operations/diagnostics": {
        ...
        get: operations["operational_diagnostics_api_v1_operations_diagnostics_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/operations/emergency-stop": {
        ...
        /**
         * Emergency Stop
         * @description Fail closed globally; remote cancellation remains pending until observed.
         */
        post: operations["emergency_stop_api_v1_operations_emergency_stop_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/operations/qualifications": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Start Qualification */
        post: operations["start_qualification_api_v1_operations_qualifications_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/operations/qualifications/{qualification_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Qualification */
        get: operations["get_qualification_api_v1_operations_qualifications__qualification_id__get"];
        put?: never;
        /** Update Qualification */
        post: operations["update_qualification_api_v1_operations_qualifications__qualification_id__post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/operations/recovery": {
        ...
        put?: never;
        /** Recovery Control */
        post: operations["recovery_control_api_v1_operations_recovery_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/operations/retention/preview": {
        ...
        put?: never;
        /** Retention Preview */
        post: operations["retention_preview_api_v1_operations_retention_preview_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * AgentRoleSpec
         * @description Versioned responsibility; execution bindings remain separate.
         */
        AgentRoleSpec: {
            /** Instructions */
            instructions: string;
        ...
        AlertEvaluationRequest: {
            /**
             * Approval Overdue Seconds
             * @default 86400
             */
            approval_overdue_seconds: number;
            /** Idempotency Key */
        ...
        EmergencyStopRequest: {
             ...
             * @constant
             */
            confirmation: "STOP ALL NEW AND ACTIVE WORK";
        ...
        EmergencyStopResult: {
             ...
             * @constant
             */
            remote_outcomes: "pending_evidence";
        };
        /**
         * EventCategory
         * @enum {string}
        ...
        ManagementTurnPage: {
            /** Items */
            items: components["schemas"]["ManagementTurnView"][];
            /** Next After */
            next_after?: string | null;
        };
        /** ManagementTurnView */
        ManagementTurnView: {
             ...
             */
            created_at: string;
            decision?: components["schemas"]["ManagerDecision"] | null;
            /** Directive Version */
             ...
             * @enum {string}
             */
            status: "queued" | "running" | "applied" | "stale" | "failed";
            /** Team Version */
            team_version: number;
        };
        /** ManagerDecision */
        ...
        MissionMessagePage: {
            /** Items */
            items: components["schemas"]["MissionMessageView"][];
            /** Next After */
            next_after?: number | null;
        };
        /** MissionMessageView */
        MissionMessageView: {
             ...
             * @enum {string}
             */
            disposition: "queued" | "delivered" | "stale" | "failed";
            /**
             * Id
             * Format: uuid
             */
        ...
        MissionPage: {
            /** Items */
            items: components["schemas"]["MissionView"][];
            /** Next After */
            next_after?: string | null;
        };
        /**
        ...
        OperationalDiagnostics: {
             ...
             * @enum {string}
             */
            correlation_coverage: "complete" | "partial" | "none";
            /** Correlation Reason */
            ...
            /** Signals */
            signals: components["schemas"]["OperationalSignal"][];
        };
        /**
         * OperationalSignal
         * @description One evidence-backed signal; unknown is intentionally not healthy.
         */
        OperationalSignal: {
            /** Action */
            action?: string | null;
        ...
        QualificationObservation: {
            ...
            external_effect_identity?: string | null;
            /** Failure Injection */
        ...
        QualificationRecord: {
            ...
            id: string;
            /** Observations */
            observations: components["schemas"]["QualificationObservation"][];
            /** Observed Seconds */
        ...
        QualificationUpdate: {
             ...
             * @enum {string}
             */
            action: "observe" | "complete" | "fail" | "cancel";
            observation?: components["schemas"]["QualificationObservation"] | null;
        };
        /** ReadinessResponse */
        ReadinessResponse: {
            /**
        ...
        RecoveryControlRequest: {
             ...
             * @enum {string}
             */
            action: "begin_restore" | "resume_dispatch";
            /** Expected Generation */
        ...
        RetentionPolicy: {
            ...
            /**
             * Source Snapshots Days
             * @default 365
             */
            source_snapshots_days: number;
            /**
             * Temporary Workspaces Days
             * @default 7
             */
            temporary_workspaces_days: number;
        };
        /** RetentionPreview */
        RetentionPreview: {
            /** Candidates */
             ...
             * @constant
             */
            execution_supported: "preview_only";
            /**
             * Generated At
             * Format: date-time
             */
...
export interface operations {
    ...
    update_directive_api_v1_missions__mission_id__directive_put: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["DirectiveUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    list_messages_api_v1_missions__mission_id__messages_get: {
        parameters: {
            query?: {
                after?: number;
                limit?: number;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["MissionMessagePage"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    create_message_api_v1_missions__mission_id__messages_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["MissionMessageCreate"];
            };
        };
        responses: {
            /** @description Successful Response */
            202: {
                ...
                content: {
                    "application/json": components["schemas"]["ManagementTurnView"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    list_items_api_v1_missions__mission_id__work_items_get: {
        parameters: {
            query?: {
                after?: string | null;
                limit?: number;
    ...
    start_item_api_v1_missions__mission_id__work_items__item_id__start_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    operational_alerts_api_v1_operations_alerts_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    evaluate_alerts_api_v1_operations_alerts_evaluate_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    operational_diagnostics_api_v1_operations_diagnostics_get: {
        parameters: {
            query?: {
                stale_after_seconds?: number;
                queue_stall_seconds?: number;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["OperationalDiagnostics"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    emergency_stop_api_v1_operations_emergency_stop_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EmergencyStopResult"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    start_qualification_api_v1_operations_qualifications_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["QualificationStart"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    get_qualification_api_v1_operations_qualifications__qualification_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    update_qualification_api_v1_operations_qualifications__qualification_id__post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    recovery_control_api_v1_operations_recovery_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RecoveryControlRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RecoveryControlResult"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    retention_preview_api_v1_operations_retention_preview_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
